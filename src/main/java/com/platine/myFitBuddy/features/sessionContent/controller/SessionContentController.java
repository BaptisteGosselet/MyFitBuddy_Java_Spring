...
public interface SessionContentController {
  ...
  ResponseEntity<List<SessionContent>> findByUserBySessionId(@RequestParam("sessionId") Long sessionId);

  @PostMapping(produces = "application/json", consumes = "application/json")
  @ResponseStatus(HttpStatus.CREATED)
  ResponseEntity<SessionContent> create(@RequestBody final SessionContentCreateForm createForm);

  @PutMapping(value = "/{sessionContentId}", produces = "application/json", consumes = "application/json")
  @ResponseStatus(HttpStatus.OK)
  ResponseEntity<SessionContent> update(@RequestBody final SessionContentUpdateForm updateForm, @RequestParam("sessionContentId") Long sessionId);
}
