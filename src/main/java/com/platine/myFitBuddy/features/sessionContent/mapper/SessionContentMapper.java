...
public class SessionContentMapper {
    public static SessionContent mapFromCreateForm(final SessionContentCreateForm sessionContentCreateForm, final DBUser user) {
    ...
    public static SessionContent mapFromUpdateForm(final SessionContentUpdateForm sessionContentUpdateForm, final Long sessionContentId, final DBUser user) {
        SessionContent sessionContent = new SessionContent();
